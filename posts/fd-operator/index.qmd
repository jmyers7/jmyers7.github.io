...
Let $\lambda$ be an eigenvalue of a an operator $T$ on a finite-dimensional Hilbert space $\calh$. The *eigenspace* of $\lambda$, denoted $\cals_\lambda$, is the span of the set
