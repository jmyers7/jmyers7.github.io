...
b. Equation: $z = - \frac{3}{4}x + \frac{1}{2}y + \frac{5}{4}$. Slope in $+x$-direction: $-\frac{3}{4}$. Slope in $+y$-direction: $\frac{1}{2}$.

c. $2x + 4y = 8$ cannot be rewritten as a point-slope equation because it does not define $z$ as a function of $x$ and $y$.

d. A normal vector to the plane is
$$
...
a. Suppose you are standing at the point $(1, 2, 3)$ on the plane with equation
$$
z = 2(x-1) + 3(y-2) + 3.
$$
    i. If you step $2$ units in the $+x$-direction, what point are you at?
    ii. If you step 1 unit in the $-x$-direction, what point are you at? 
    iii. If you step 3 units in the $-x$-direction and $4$ in the $-y$-direction, what point are you at?
b. Suppose you are standing at $(1, -2, 0)$ on the plane with equation
$$
2(x-1) -4 (y+2) +2z = 0.
$$
    i. If you step $1$ unit in the $-x$-direction, what point are you at?
    ii. If you step $2$ units in the $+y$ direction, what point are you at?
c. Consider the plane with equation
$$
2x-3y + 3z = 5.
$$
...
d. Consider the plane with equation
$$
2x + 3y + 4z = 1.
$$
...
a. $(3, 2, 7)$, $(0, 2, 1)$, $(-2, -2, -15)$


b. $(0, -2, 1)$, $(1, 0, 4)$
    

c. A normal vector with positive $z$-component is
$$
...
d. Let $\mathbf{r}$ be the position vector of the point $(2,3,-1)$, and let $\mathbf{r}_0$ be the position vector of the point $(x_0,y_0,z_0)$ on the plane closest to $(2,3,-1)$. Then it follows that the difference $\mathbf{r}-\mathbf{r_0}$ is orthogonal to the plane. But a normal vector to the plane is
$$
...
\begin{bmatrix} 1.45 \\ 2.17 \\ -2.10 \end{bmatrix}. $$
Thus, the point on the plane closest to $(2,3,-1)$ is approximately $(1.45, 2.17, -2.10)$.
:::