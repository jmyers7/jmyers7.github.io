---
title: "13 Second derivatives, part 1"
format:
    revealjs:
        incremental: true
        slide-number: true
...
i. At $(1,1)$, in the direction of $\mathbf{h} = \begin{bmatrix} 1 \\ 1 \end{bmatrix}$.
ii. At $(1,0,1)$, in the direction of $\mathbf{h} = \begin{bmatrix} 1 \\ 0 \\ 1 \end{bmatrix}$.
iii. At $(\pi/2,1,0)$, in the direction of $\mathbf{h} = \begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix}$.
