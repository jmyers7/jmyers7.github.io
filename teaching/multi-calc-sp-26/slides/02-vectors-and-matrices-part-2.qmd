...
::: {.callout-note .nonincremental icon="false"}
### a. Practice with inner produts and norms
...
::: {.callout-note .nonincremental icon="false"}
### a. Practice with matrix multiplication
Let
...
ii. Compute $\mathbf{v}A$, if possible. What is the size of the resulting matrix?
:::
...
- This is represented notationally as $f:C\to D$.
