...
Let $a$, $b$, $c$, and $d$ be constants (where not all $a$, $b$, and $c$ are $0$). The set of points $(x,y,z)$ that are solutions to the equation

$$
ax + by + cz = d
$$

forms a plane in $\mathbb{R}^3$. This is called an **affine equation** of a plane.
:::

::: {.callout-warning .fragment}

Be very, **VERY** careful: The constants $a$, $b$, and $c$ in an affine equation are **NOT** (in general) the components of a normal vector to the plane.
