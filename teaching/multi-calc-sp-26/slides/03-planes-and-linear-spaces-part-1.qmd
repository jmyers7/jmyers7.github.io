...
## Exercise 1: Computing point-slope equations
...
## Exercise 3: Normal vectors {.scrollable}
...
## Exercise 4: "Non-homogeneous" linear equations {.scrollable}

::: {.callout-note icon="false" .nonincremental appearance="minimal"}

Let $a$, $b$, $c$, and $d$ be constants, not all $0$. The set of points $(x,y,z)$ that are solutions to the equation

$$
ax + by + cz = d
$$

form a plane in $\mathbb{R}^3$. Explain why.
