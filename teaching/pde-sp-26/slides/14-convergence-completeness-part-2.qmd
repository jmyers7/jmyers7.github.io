...
- We will not prove this; it requires a bit more "analysis" style techniques than is appropriate for this course.

## Exercise 1: Fourier series in $L^2(-\pi,\pi)$ {.scrollable}
...
## Summary of convergence of Fourier series {.scrollable}
...
- In the second bullet point, we are ignoring the (finitely many) points of discontinuity of $f$.